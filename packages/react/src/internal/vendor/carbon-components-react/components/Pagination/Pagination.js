...
import CaretRight24 from '@carbon/icons-react/es/caret--right/24';import CaretLeft24 from '@carbon/icons-react/es/caret--left/24';
...
function (_Component) {
  ...
  _createClass(Pagination, [{
    ...
    value: function render() {
      ...
      }, selectItems), React.createElement("span", {
        className: "".concat(prefix, "--pagination__text")
